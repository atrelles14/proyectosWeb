...
if ($http_status === 200) {
    ...
    margin-right: 5px; /* Ajusta el espacio entre la flecha y el texto */
        ...
        .table-container {
    margin: 80px auto; /* Establece un margen superior e inferior de 100px y centrará horizontalmente */
    ...
    <table>
        ...
        foreach ($fields as $campo => $label) {
            ...
            <tr>
                ...
                <td><a href='../VIEW_USERS/editar_perfil.php?campo=<?php echo $campo; ?>&id=<?php echo $id_usuario; ?>'>Editar</a></td>
            </tr>
            <?php
        }
        ?>
